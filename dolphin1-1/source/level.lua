...
-- 			coin.x, coin.y, cols, cols_len = coin:moveWithCollisions(coin.x, coin.y)
			
-- 			for i=1, cols_len do
-- 				local col = cols[i]      
-- 				if col.normal.x ~= 0 then -- hit something in the X direction
-- 					coin:changeDirections()
-- 				end
-- 			end
...
function Level:collectCoin(coin)
	...
	collector()
	playdate.frameTimer.performAfterDelay(8, removeCoin, coin)
	SoundManager:playSound(SoundManager.kSoundCoin)
